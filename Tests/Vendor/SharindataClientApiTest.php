...
class SharindataClientApiTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testConnexion(){
        $sca = \KkuetNet\SharindataClientApi\Vendor\SharindataClientApi::getInstance("kkuet12@live.fr", "05068");
        $data= $sca->getCountries();
        $this->assertTrue($data->code==401);
        $sca = \KkuetNet\SharindataClientApi\Vendor\SharindataClientApi::getInstance("kkuet1@live.fr", "05068");
        $data= $sca->getCountries();
        $this->assertTrue($data->code==401);
